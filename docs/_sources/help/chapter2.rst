...
-  **요금 관리:** 요금제, 실시간 이용 현황 및 결제 내역을 조회하고 요금제나 결제 수단을 변경할 수 있습니다.
   ...
   -  **결제 내역:** 최근 1년간의 결재 내역을 확인할 수 있습니다.
...
**① 템플릿으로 문서 작성**
   즐겨찾기한 템플릿, 최근에 사용한 템플릿, 최근에 업로드한 ,,,저장된 템플릿을 사용하여 새 문서를 작성할 수 있는 **템플릿으로 문서 작성** 화면으로 이동합니다.
...
**③ 즐겨찾기**
   ...
   .. tip::
      ...
      **자주 사용하는 템플릿 즐겨찾기에 추가하는 방법!**
      ...
      자주 사용하는 템플릿은 즐겨찾기에 등록하면 대시보드에서 가장 우선순위로 표시됩니다. 템플릿 **즐겨찾기**\ 는 **템플릿으로 문서 작성** 화면에서 할 수 있습니다.
      ...
      4. (|image5|) 아이콘을 다시 클릭하면 즐겨찾기 해제됩니다. 
...
-  **템플릿별 권한**
   ...
   -  **템플릿 수정 권한**
      ...
      ❗템플릿 수정 권한은 **템플릿 관리자 권한이 있는 멤버만 지정**\ 할 수 있습니다.
...
문서에 직접 서명이 아닌 직인이나 도장을 사용해야 하는 경우가 있습니다. 이폼사인에서는 도장을 온라인에서 바로 만들거나, 도장 이미지를 등록하거나, 실물 도장을 실물 크기 그대로 스캔하여 등록한 후 문서의 서명란에 도장을 찍을 수 있습니다.
