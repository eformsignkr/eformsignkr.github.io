...
이폼사인 로그인 후 대시보드 대시보드 화면 왼쪽 상단의 메뉴(|image1|)를 클릭하면, 아래와 같은 사이드바 메뉴가 나타납니다. 메뉴는 사용자의 권한에
따라 다르게 나타날 수 있습니다. 대표 관리자는 모든 메뉴를 볼 수 있으며, 모든 권한이 있습니다.
...
-  **새 문서 작성:** 내 PC에 저장된 문서 파일 또는 eformsign에 등록된 작성 가능한 템플릿 중 선택하여 문서를 작성합니다.
   ...
   -  **내 파일로 문서 작성:** 미리 저장된 템플릿이 없더라도 내 PC의 파일(PDF)을 eformsign에 바로 업로드한 후 필요한 컴포넌트를 문서
      위에 배치하여 수신자에게 전송합니다.
...
-  **문서함:** 나와 관련된 문서 목록을 확인합니다.
   ...
   -  **처리할 문서함:** 내가 작성 또는 처리한 문서 중 결재, 작성, 요청 등 내가 처리할 사항이 있는 문서 목록을 볼 수 있습니다.
...
한눈에 확인할 수 있으며, **새 문서 작성하기** 등 주요 메뉴로 바로가기를 제공합니다.
...
이폼사인은 멤버에게 권한을 부여할 수 있으며, 총 5단계로 세분화된 권한별 관리가 가능합니다. 사용자별 권한은 다음과 같이 구분됩니다.
...
-  **템플릿 사용 권한**
   ...
   템플릿 사용 권한은 템플릿으로 문서를 작성할 수 있는 권한을 말합니다. 템플릿 별로 **템플릿 사용 권한(문서 작성 권한)**\ 을 부여할 수 있습니다. 권한을 부여 받은 멤버의 **템플릿으로 문서 작성** 화면에 해당 템플릿이 나타나며 문서를 작성할 수 있습니다.
...
각 템플릿 별로 문서를 생성할 수 있는 권한과 생성된 문서와 문서에 입력된 데이터를 관리하는 권한을 부여할 수 있습니다.
...
.. note::
   ...
   **회사 관리** > **서명 설정** 에서 그리기, 텍스트, 도장 중 문서의 서명란에 표시될 서명 방식을 제한하거나 허용할 수 있습니다.
