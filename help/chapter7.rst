...
**템플릿**\ 은 이폼사인에서 반복적으로 사용하는 문서를 미리 저장해 놓은 재사용 가능한 서식입니다. 기존에 종이로 작성하던 계약서, 신청서, 동의서와 같이 자주 사용하는 문서의 기본 서식을 템플릿으로 미리 만들어 놓고 간편하게 문서를 작성할 수 있습니다. 템플릿은 이폼사인 서비스 내에서 파일을 업로드해 만들거나 MS Office에서 바로 만들고 업로드할 수 있습니다. 
...
.. figure:: resources/workflow-needtoview-properties-fb.png
...
.. figure:: resources/template-setting-notification-channel1.png
   :alt: 알림 채널 설정
...
**템플릿 관리** 화면에서 템플릿 이름 오른쪽에 위치한 더보기(⋯)를 클릭하면 각 템플릿별 메뉴가 나타납니다.
...
**③ 검색 고정 및 초기화**
   검색 조건을 고정하거나 초기화할 수 있습니다.

**④ 정렬**
   템플릿 정렬 순서를 템플릿 이름, 카테고리 기준 또는 최근 수정일 기준으로 오름차순, 내림차순을 설정합니다.
