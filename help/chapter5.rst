...
4. 문서에 맞게 서명 참여자를 추가하고 역할을 설정합니다.
...
5. 참여자가 입력해야 하는 입력항목를 선택하여 문서에 드래그합니다.
...
6. 입력항목의 크기와 위치를 조정합니다.

7. 해당 입력항목의 속성에서 상세 설정을 합니다.

8. **미리보기** 버튼을 클릭해 문서를 확인합니다.

9. 폼 디자인을 마친 후 **설정하기**\ 를 클릭하여 템플릿 설정으로 이동합니다.
...
.. tip::
   ...
   **문서 제목 변경 허용** 여부를 확인하세요!
   ...
   문서 제목 규칙을 설정해 놓더라도 **문서 제목 변경 허용**\ 이 체크되어 있으면 문서 작성자가 임의로 문서 제목을 변경할 수 있습니다. 문서 제목이 변경되는 것을 원하지 않는 경우 **문서 제목 변경 허용**\ 을 체크 해제해 주세요.
