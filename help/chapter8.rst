...
- 카테고리 필터: 템플릿 설정 시 설정한 카테고리별로 문서를 볼 수 있습니다.
...
.. note::
   ...
   **문서 삭제하는 방법**
   ...
   문서 삭제는 **문서 관리자 권한**\ 이 필요하며, 문서 관리자 설정은 대표 관리자가 **회사 관리 > 권한 관리**\ 메뉴에서 할 수 있습니다.
...
2. 필드 이름, 필드 타입, 검색 값을 설정합니다.
   ...
   필드 타입은 키워드, 범위, 기간 타입 중에 선택합니다. 필드 타입 선택에 따라 검색 값으로 표시되는 입력 박스가 다릅니다.
